...
- Investigation docs:
  - `docs/post-investigation/blur-daemon-approach.md` - Detailed architectural justification
  - `docs/post-investigation/addendum-why-ipc-is-better.md` - Tight vs loose coupling analysis
  - `docs/investigation/scenefx-investigation/investigation-summary.md` - SceneFX blur implementation
  - `docs/post-investigation/comprehensive-synthesis1.md` - Three-compositor comparison

- scroll maintainer discussion: `docs/pre-investigation/scrollwm-maintainer-discussion.md`
- Related: ADR-002 (DMA-BUF choice), ADR-004 (IPC protocol design)
