...
- Investigation docs:
  - `docs/investigation/scenefx-investigation/investigation-summary.md` - Complete SceneFX analysis
  - `docs/investigation/wayfire-investigation/02-algorithm-analysis.md` - Wayfire algorithms
  - `docs/investigation/hyprland-investigation/blur-algorithm.md` - Hyprland blur + vibrancy
...
- Related ADRs:
  - ADR-003: Kawase algorithm choice (justifies Wayfire extraction)
  - ADR-002: DMA-BUF choice (justifies SceneFX extraction)
