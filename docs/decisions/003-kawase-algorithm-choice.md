...
- Investigation docs:
  - `docs/investigation/scenefx-investigation/investigation-summary.md` - Dual Kawase implementation details (lines 20-37)
  - `docs/investigation/wayfire-investigation/02-algorithm-analysis.md` - Algorithm comparison
  - `docs/post-investigation/comprehensive-synthesis1.md` - Performance characteristics (lines 156-197)
...
- Related ADRs:
  - ADR-005: SceneFX extraction (Kawase shader porting)
