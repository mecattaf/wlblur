...
- Investigation docs:
  - `docs/investigation/scenefx-investigation/investigation-summary.md` - DMA-BUF import patterns (lines 105-128)
  - `docs/post-investigation/comprehensive-synthesis1.md` - Zero-copy architecture analysis (lines 363-378)
...
- Related ADRs:
  - ADR-001: External daemon architecture (motivates need for cross-process GPU sharing)
  - ADR-004: IPC protocol design (DMA-BUF FDs passed via protocol)
